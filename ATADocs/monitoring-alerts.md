...
В этой статье описаны все оповещения о работоспособности для каждого компонента, перечислены причины и шаги, необходимые для решения проблемы.
...
|Предупреждение|Описание|Решение|Severity|
|----|----|----|----|

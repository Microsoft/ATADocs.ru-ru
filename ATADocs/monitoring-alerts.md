...
### <a name="ata-center-running-out-of-disk-space"></a>Нехватка места на диске для центра ATA
...
### <a name="failure-sending-mails"></a>Сбой при отправке электронной почты
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="ata-center-overloaded"></a>Центр ATA перегружен
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="ata-center-certificate-is-about-to-expire"></a>Истекает срок действия сертификата центра ATA
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="read-only-user-password-is-about-to-expire"></a>Истекает срок действия доступного только для чтения пароля пользователя
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="ata-gateway-certificate-about-to-expire"></a>Истекает срок действия сертификата шлюза ATA
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="ata-gateway-certificate-expired"></a>Срок действия сертификата шлюза ATA истек
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="allsome-of-the-capture-network-adapters-on-an-ata-gateway-are-not-available"></a>Недоступны все или некоторые сетевые адаптеры захвата в шлюзе ATA
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="some-domain-controllers-are-unreachable-by-a-ata-gateway"></a>Некоторые контроллеры домена недоступны для шлюза ATA
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="all-domain-controllers-are-unreachable-by-a-ata-gateway"></a>Все контроллеры домена недоступны для шлюза ATA
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="ata-gateway-stopped-communicating"></a>Шлюз ATA перестал обмениваться данными
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="ata-gateway-version-outdated"></a>Версия шлюза ATA устарела
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="ata-gateway-service-failed-to-start"></a>Не удалось запустить службу шлюза ATA
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
...
### <a name="lightweight-ata-gateway-reached-a-memory-resource-limit"></a>Упрощенным шлюзом ATA достигнуто ограничение на ресурсы памяти
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|

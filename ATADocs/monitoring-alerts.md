...
|Оповещение|Описание|Разрешение|Статус|
|----|----|----|----|
|Из шлюза ATA не поступают данные. Период времени по умолчанию для этого оповещения составляет 5 минут.|Сетевой трафик больше не записывается сетевым адаптером в этом шлюзе ATA. Это сказывается на возможности обнаружения подозрительных действий решением ATA, так как сетевой трафик не поступает в центр ATA.|Проверьте не блокируется ли порт, используемый для обмена данными между шлюзом ATA и службой центра ATA, маршрутизаторами или брандмауэрами.|Средняя|

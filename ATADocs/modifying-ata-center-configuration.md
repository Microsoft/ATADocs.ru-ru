---
title: Изменение конфигурации центра Advanced Threat Analytics ATA
...
3. Дождитесь синхронизации шлюзов ATA. Теперь у них есть два возможных URL-адреса, с помощью которых можно получить доступ к консоли ATA. Пока шлюз ATA может подключиться с помощью исходного URL-адреса, новый адрес использоваться не будет.
...
3. Дождитесь синхронизации шлюзов ATA. Теперь у них есть два потенциальных сертификата, которые действительны для взаимной проверки подлинности. Пока шлюз ATA может подключиться с помощью исходного сертификата, новый сертификат использоваться не будет.

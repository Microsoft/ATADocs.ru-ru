...
4. Если платформа Microsoft .NET Framework не установлена, при запуске установки будет предложено установить ее. После установки платформы .NET Framework может появиться запрос на перезагрузку.
5. На странице **приветствия** выберите язык, который будет использоваться для экранов установки ATA, и нажмите кнопку **Далее**.

...
9. На странице **настройки центра** введите указанные ниже сведения с учетом используемой среды.
   ...
   |Поле|Описание|Comments|
   |---------|---------------|------------|
   |Installation Path|Это расположение для установки центра ATA. По умолчанию этот путь — %programfiles%\Microsoft Advanced Threat Analytics\Center.|Оставьте значение по умолчанию.|

...
ATA состоит из двух основных компонентов — центра и шлюза ATA. Дополнительные сведения о компонентах ATA см. в статье [Архитектура ATA](/advanced-threat-analytics/Understand/ata-architecture).
...
Поддерживается установка центра ATA в качестве виртуальной машины. Дополнительные сведения см. в статье [Настройка зеркального отображения портов](configure-port-mirroring.md).
...
>
> - Центру ATA требуются данные минимум за 21 день, чтобы проанализировать поведение пользователя.
>
...
Дополнительные сведения см. в статье [Планирование производительности ATA](ata-capacity-planning.md).

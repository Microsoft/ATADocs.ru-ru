...
Перед установкой упрощенного шлюза ATA на контроллере домена под управлением Windows Server 2012 R2 с пакетом обновления 1 (SP1) убедитесь, что установлены следующие обновления: [KB2919355](https://support.microsoft.com/kb/2919355/) и [KB3000850](https://support.microsoft.com/help/3000850/november-2014-update-rollup-for-windows-rt-8.1,-windows-8.1,-and-windows-server-2012-r2) (в этом порядке). 

Проверку можно выполнить, запустив следующий командлет Windows PowerShell: `[Get-HotFix -Id kb2919355] [Get-HotFix -Id KB3000850]`.

> [!NOTE]
> Требуется не менее 5 ГБ пространства; рекомендуется 10 ГБ. Сюда входит пространство, необходимое для двоичных файлов ATA, [журналов ATA](/advanced-threat-analytics/troubleshoot/troubleshooting-ata-using-logs.md) и [журналов производительности](/advanced-threat-analytics/troubleshoot/troubleshooting-ata-using-perf-counters.md).

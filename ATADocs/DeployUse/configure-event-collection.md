...
*Применимо к Advanced Threat Analytics версий 1.6 и 1.7*
...
### Настройка пересылки событий Windows для упрощенного шлюза ATA
...
**Шаг 2. Выполните следующие действия на контроллере домена после установки облегченного шлюза ATA.** 

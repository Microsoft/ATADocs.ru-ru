...
Хотя данные в ATA реплицируются и всегда обновляются из AD, при удалении сущности в AD данные сущности в ATA сохраняются в целях расследования в области безопасности. 
...
1. Скопируйте его в папку ATA (расположенную в `"C:\Program Files\Microsoft Advanced Threat Analytics\Center\MongoDB`) и выполните на компьютере с центром ATA следующую команду: 
...
- Сведения о надежности и соответствии требованиям ATA см. на портале [Service Trust Portal](https://servicetrust.microsoft.com/ViewPage/GDPRGetStarted) и на сайте [соответствия GDPR Microsoft 365 Enterprise](/microsoft-365/compliance/gdpr).
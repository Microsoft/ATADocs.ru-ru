...
Чтобы понять концепцию потока внутренних компонентов АТА, ознакомьтесь с [архитектурой АТА](ata-architecture.md).
...
2.  Остановите набор сборщиков данных **Microsoft ATA Gateway** или **Microsoft ATA Center**.
...
Для этого нужно открыть **системный монитор** и добавить все счетчики для облегченного шлюза АТА. Объектам счетчиков производительности присвоены имена **Microsoft ATA Gateway** (Шлюз Microsoft ATA) и **Microsoft ATA Gateway Updater** (Средство обновления шлюза Microsoft ATA).

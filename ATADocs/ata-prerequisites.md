...
|Виртуальная машина запущена на|Description|
|------------|-------------|
|Hyper-V|Убедитесь, что параметр **включить динамическая память** не включен для виртуальной машины.|
|VMWare|Убедитесь, что настроенный объем памяти и зарезервированная память одинаковы, или выберите следующий параметр в параметре виртуальной машины — **резервировать всю гостевую память (все заблокированные)** .|

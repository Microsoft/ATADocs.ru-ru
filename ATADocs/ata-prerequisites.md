...
|Протокол|Транспорт|Порт|В/Из|Direction|
|------------|-------------|--------|-----------|-------------|
...
|**SMTP** (необязательно)|TCP|25|SMTP Server|Исходящее|
|**SMTPS** (необязательно)|TCP|465|SMTP Server|Исходящее|

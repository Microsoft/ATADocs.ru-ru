...
|**Протокол**|TCP|443|Сеть организации и шлюз ATA|Входящий трафик|
|**SMTP** (необязательно)|TCP|25|SMTP-сервер|Исходящие|
|**SMTPS** (необязательно)|TCP|465|SMTP-сервер|Исходящие|
|**Системный журнал** (необязательно)|TCP/ИБП/TLS (настраиваемые)|514 (по умолчанию)|Сервер системного журнала|Исходящие|

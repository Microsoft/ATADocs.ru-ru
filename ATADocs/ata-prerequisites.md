...
Дополнительные сведения о динамической памяти и других функциях отображения памяти см. в разделе [Динамическая память](#dynamic-memory).

...
|**SMTP** (необязательно)|TCP|25|SMTP-сервер|Исходящий трафик|
|**SMTPS** (необязательно)|TCP|465|SMTP-сервер|Исходящий трафик|
|**Системный журнал** (необязательно)|TCP/ИБП/TLS (настраиваемые)|514 (по умолчанию)|Сервер системного журнала|Исходящий трафик|
|**LDAP**|TCP и UDP|389|Контроллеры домена|Исходящее|
|**LDAPS** (необязательно)|TCP|636|Контроллеры домена|Исходящее|
|**DNS**|TCP и UDP|53|"Серверы DNS"|Исходящий трафик|

...
|Используемый протокол|Транспорт|Port|В/Из|Direction (направление)|
|------------|-------------|--------|-----------|-------------|
...
|**SMTP** (необязательно)|TCP|25|Сервер SMTP|Исходящий|
|**SMTPS** (необязательно)|TCP|465|Сервер SMTP|Исходящий|
...
|**Служба времени Windows** (необязательно при присоединении к домену)|Протокол UDP|123|Контроллеры доменов|Исходящий|
...
|Служба времени Windows|Протокол UDP|123|Контроллеры доменов|Исходящий|
|Служба доменных имен (DNS)|TCP и UDP|53|DNS-серверы|Исходящий|
|HTML через RPC|TCP|135|Все устройства в сети|Оба варианта|
|NetBIOS|Протокол UDP|137|Все устройства в сети|Оба варианта|
|SSL|TCP|443|Центр АТА|Исходящий|
|Syslog (необязательно)|Протокол UDP|514|Сервер SIEM|Входящие|

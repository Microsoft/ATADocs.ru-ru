...
> |-------------|----------|---------|---------|
> |Тихий NaN|/quiet|Да|Запускает установщик, не отображая пользовательский интерфейс и запросы.|
...
> |-------------|----------|---------|---------|
> |Тихий NaN|/quiet|Да|Запускает программу удаления, не отображая пользовательский интерфейс и подсказки.|

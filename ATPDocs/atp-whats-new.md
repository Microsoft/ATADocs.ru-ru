...
Дата выпуска: 28 октября 2018 г.
...
- **Добавление конфигурации: управление доступом на основе ролей клиентов (RBAC)**
...
Дата выпуска: 21 октября 2018 г.
...
- Временное увеличение количества оповещений безопасности **Разведывательная атака с использованием запросов к службам каталогов** 16 сентября 2018 года было изучено, и его причины были устранены. 

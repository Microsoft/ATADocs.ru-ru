...
- **Новое оповещение системы безопасности: Разведывательная атака, направленная на субъекта безопасности (LMP) — предварительная версия**<br>
...
- **Расширение функциональности: Оповещение о разведывательной атаке путем сетевого сопоставления (DNS)** <br>
    В оповещения о разведывательной атаке путем сетевого сопоставления (DNS) добавлены новые типы обнаружения. Кроме подозрительных запросов AXFR, Azure ATP теперь также обнаруживает подозрительные типы запросов от серверов, не использующих DNS и отправляющих чрезмерно большое количество запросов.

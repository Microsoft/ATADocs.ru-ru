...
Серия предупреждений системы безопасности Azure ATP о нестандартной реализации протоколов, которая ранее имела один общий идентификатор externalId (2002), теперь разделена на четыре отдельных предупреждения с уникальными внешними идентификаторами. 

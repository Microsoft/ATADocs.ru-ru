...
- Azure ATP вместе с Microsoft Cloud App Security (MCAS) и службой "Защита идентификации Azure Active Directory (Azure AD)" реализуют универсальный интерфейс для анализа пользовательских действий в локальных и облачных средах, а также включают расширенные возможности обнаружения в рамках аналитики поведения пользователей и сущностей (UEBA).

...
1. **Разрешение сетевых имен**<br>
   ...
   Запросы выполняются одним из четырех методов: 
    ...
    Получив имя компьютера, датчики Azure ATP проверяют сведения в Active Directory наличие объекта-компьютера, связанного с таким именем. Если соответствие найдено, устанавливается связь между IP-адресом и соответствующим объектом-компьютером.

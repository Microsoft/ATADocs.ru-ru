...
Для работы первых трех методов необходимо открыть соответствующие порты для входящего трафика с датчиков Azure ATP на устройства в сети. Дополнительные сведения о политике NNR в Azure ATP см. в [этой статье](atp-nnr-policy.md).

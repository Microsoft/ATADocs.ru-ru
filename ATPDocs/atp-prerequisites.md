...
- **Токен-приманка** (необязательно): учетная запись пользователя, не совершающего операции в сети. Эта учетная запись будет настроена как пользователь Honeytoken Azure ATP. Дополнительные сведения об использовании токенов-приманок: [Настройка учетных записей Honeytoken и исключений из обнаружения](install-atp-step7.md).

...
При таком обнаружении [!INCLUDE [Product short](includes/product-short.md)] может определить, откуда пришла атака перечисления учетных записей, а также сколько всего попыток угадывания и успешных совпадений было. Если неизвестных пользователей слишком много, [!INCLUDE [Product short](includes/product-short.md)] распознает это как подозрительное действие.

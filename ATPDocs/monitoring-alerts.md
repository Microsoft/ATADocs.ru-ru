...
|Оповещение|Описание|Решение|Статус|
|----|----|----|----|
|Датчик Azure ATP устарел.|Используется версия датчика Azure ATP, которая на три или более версий старше текущей.|Обновите датчик вручную и выясните, почему он не обновляется автоматически. Если это не помогло, скачайте последний пакет установки датчика и переустановите датчик. Дополнительные сведения см. в разделе [Установка датчика Azure ATP](install-atp-step4.md).|Средняя|

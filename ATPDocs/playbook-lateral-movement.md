---
title: Оповещение системы безопасности Azure ATP бокового смещения перемещение сборник тренировочных заданий
...
ms.locfileid: "90828548"
---
# <a name="tutorial-lateral-movement-playbook"></a>Учебник. бокового смещения сборник тренировочных заданий перемещения
...
> [Сборник схем захвата управления доменом в Azure ATP](playbook-domain-dominance.md)

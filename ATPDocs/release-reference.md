...
В список исключаемых доменов по умолчанию добавлены три новых часто используемых домена. Список исключений по-прежнему является полностью настраиваемым. Дополнительные сведения см. в разделе [Настройка исключений обнаружения](configure-detection-exclusions.md).

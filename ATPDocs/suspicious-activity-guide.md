...
## <a name="suspicious-domain-controller-promotion-potential-dcshadow-attack---new"></a>Подозрительное повышение роли контроллера домена (потенциальная атака DCShadow) — обновлено
...
> [!NOTE]
> Обнаружение подозрительного повышения роли контроллера домена (потенциальная атака DcShadow) доступно только для датчиков ATP. 


## <a name="suspicious-replication-request-potential-dcshadow-attack---new"></a>Подозрительный запрос на репликацию (потенциальная атака DCShadow) — обновлено
...
> [!NOTE]
> Обнаружение подозрительного запроса на репликацию (потенциальная атака DcShadow) доступно только для датчиков ATP. 

...
3.   Если зарегистрированный домен не является надежным, определите процесс создания запроса на исходном компьютере. Для выполнения этой задачи можно использовать [Монитор процессов](https://docs.microsoft.com/en-us/sysinternals/downloads/procmon).
4.  Когда началась подозрительная активность? Были ли развернуты или установлены в организации какие-либо новые программы, например антивирусные? Были ли в то же время получены другие оповещения?

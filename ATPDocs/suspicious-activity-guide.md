...
Сначала проверьте описание оповещения, чтобы узнать, с каким именно типом обнаружения вы столкнулись. Чтобы получить дополнительные сведения, скачайте электронную таблицу Excel.

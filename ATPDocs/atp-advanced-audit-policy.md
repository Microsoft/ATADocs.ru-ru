---
title: Проверка расширенной политики аудита Расширенной защиты от угроз Azure
...
![Оповещение о работоспособности расширенной политики аудита](media/atp-health-alert-audit.png)
...
6. Перейдите к управлению учетными записями, дважды щелкните **Аудит управления группами безопасности** и выберите параметр **Настроить следующие события аудита** для успешных и неудачных событий.
    ...
    > [!NOTE] 
    > Если для применения параметров расширенной политики аудита используется политика, отличная от политики контроллера домена по умолчанию, итоговое оповещение о работоспособности Azure ATP можно игнорировать. 

---
layout: LandingPage
description: "Научитесь использовать Azure Advanced Threat Protection."
...
---
# <a name="azure-advanced-threat-protection-documentation"></a>Документация по Azure Advanced Threat Protection
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Дополнительные сведения об Azure Advanced Threat Protection</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Архитектура Azure Advanced Threat Protection</h3>
                    </div>
                </div>
            </div>
        </div>

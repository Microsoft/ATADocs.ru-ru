...
### <a name="how-can-i-use-defender-for-identity-information-in-an-investigation"></a>Как применять сведения Defender для удостоверений при анализе?
...
## <a name="defender-for-identity-and-nnr-network-name-resolution"></a>Defender для удостоверений и механизм разрешения сетевых имен (NNR)

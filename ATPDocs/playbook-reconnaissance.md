...
### <a name="network-mapping-reconnaissance-dns-detected-in-defender-for-identity"></a>Обнаружение рекогносцировки сетевого сопоставления (DNS) в Defender для удостоверений
...
### <a name="directory-service-enumeration-detected-in-defender-for-identity"></a>Обнаружение перечисления служб каталогов в Defender для удостоверений
...
### <a name="user-and-ip-address-reconnaissance-smb-detected-in-defender-for-identity"></a>Обнаружение рекогносцировки пользователей и IP-адресов (SMB) в Defender для удостоверений

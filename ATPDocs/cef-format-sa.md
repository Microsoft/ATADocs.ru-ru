...
-   shost — компьютер, выдавший оповещение
...
-   cs#label и cs# — пользовательские строки, разрешенные форматом CEF. Строка cs#label — это имя нового поля, а cs# — значение, например: cs1Label=url cs1=https://192.168.0.220/suspiciousActivity/5909ae198ca1ec04d05e65fa

...
|Имя оповещения системы безопасности|Уникальный идентификатор ExternalId|
|---------|---------|
|Атака методом подбора с помощью простой привязки LDAP|2004|
|Понижение уровня шифрования — использование мастер-ключа|2011|
|Понижение уровня шифрования (потенциальная атака Overpass-the-Hash)|2008|
|Понижение уровня шифрования (потенциальная атака Golden Ticket)|2009|
|Понижение уровня шифрования (потенциальная атака с использованием мастер-ключа)|2010|
|Действие Honeytoken|2014|
|Кража удостоверения с помощью атаки Pass-the-Hash|2017|
|Кража удостоверения с помощью атаки Pass-the-Ticket|2018|
|Атака Golden Ticket Kerberos — аномальное время|2022|
|Атака Golden Ticket Kerberos — несуществующая учетная запись|2027|
|Вредоносный запрос конфиденциальных сведений для защиты данных.|2020|
|вредоносная репликация служб каталогов;|2006|
|Атака, направленная на повышение привилегий с использованием поддельных данных авторизации|2013|
|Разведывательная атака с использованием перечисления учетных записей.|2003|
|Разведывательная атака с использованием DNS.|2007|
|Разведывательная атака с использованием перечисления сеансов SMB|2012|
|разведывательная атака с использованием запросов к службам каталогов;|2021|
|Попытка удаленного выполнения кода|2019|
|Подозрительные неудачные попытки проверки подлинности|2023|
|Подозрительный запрос на репликацию контроллера домена (потенциальная атака DCShadow)|2029|
|Подозрительное повышение роли контроллера домена (потенциальная атака DCShadow)|2028|
|Подозрительный обмен данными через DNS|2031|
|Подозрительное изменение привилегированных групп|2024|
|Создание подозрительной службы|2026|
|Подозрительные VPN-подключения|2025|
|Нестандартное использование протоколов (потенциальная атака программы-шантажиста WannaCry)*|2002|
|Нестандартное использование протоколов (потенциальное использование вредоносных средств, таких как Hydra)*|2002|
|Нестандартное использование протоколов (потенциальное использование средств взлома Metasploit)*|2002|
|Нестандартное использование протоколов Kerberos (потенциальная атака Overpass-the-Hash)*|2002|
...
### <a name="encryption-downgrade-activity---golden-ticket"></a>Понижение уровня шифрования — атака Golden Ticket
...
### <a name="unusual-protocol-implementation--potential-use-of-malicious-tools-such-a-metasploit"></a>Нестандартное использование протоколов (потенциальное использование вредоносных средств, таких как Metasploit)

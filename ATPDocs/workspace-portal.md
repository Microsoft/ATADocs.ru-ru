...
1. Чтобы войти на портал Azure ATP, можно войти на портал [https://portal.atp.azure.com](https://portal.atp.azure.com) и выбрать соответствующую рабочую область либо перейти по URL-адресу рабочей области: [https://*имя_рабочей_области*.atp.azure.com](https://*workspacename*.atp.azure.com).

...
### <a name="remote-code-execution-detection-in-defender-for-identity"></a>Обнаружение удаленного выполнения кода в Defender для удостоверений
...
### <a name="dpapi-detection-in-defender-for-identity"></a>Обнаружение DPAPI в Defender для удостоверений
...
#### <a name="malicious-replication-detection-in-defender-for-identity"></a>Обнаружение вредоносной репликации в Defender для удостоверений
...
### <a name="skeleton-key-attack-detection-in-defender-for-identity"></a>Обнаружение атаки с использованием мастер-ключа в Defender для удостоверений

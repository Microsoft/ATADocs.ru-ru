...
Сведения о требованиях лицензирования Azure ATP см. в [руководстве по лицензированию Azure ATP](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#azure-advanced-threat-protection).
...
Для каждого контроллера домена в среде должен существовать датчик или автономный датчик ATP. Дополнительные сведения см. в разделе [Размеры датчиков Azure ATP](capacity-planning.md#sizing).
...
Датчик Azure ATP поддерживает большинство виртуальных контроллеров домена. Сведения о том, как определить, пригодна ли ваша среда для размещения датчиков Azure ATP, см. в статье [Планирование производительности Azure ATP](capacity-planning.md).
...
Azure Advanced Threat Protection поддерживает многодоменные среды и множество лесов. Дополнительные сведения и требования безопасности см. в описании [поддержки множества лесов](multi-forest.md).
...
Просмотрите сведения о последней ошибке в текущем [журнале](troubleshooting-using-logs.md) ошибок (в месте установки Azure ATP в папке Logs).
